...
class Smarty_Internal_Method_CompileAllTemplates {
    ...
    Smarty $smarty, $extension = '.tpl', $force_compile = false, $time_limit = 0, $max_errors = null
    ) {
    ...
    Smarty $smarty, $extension, $force_compile, $time_limit, $max_errors, $isConfig = false
    ) {
