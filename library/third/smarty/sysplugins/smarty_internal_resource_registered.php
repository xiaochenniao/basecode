...
class Smarty_Internal_Resource_Registered extends Smarty_Resource {
    ...
    public function getTemplateTimestamp(Smarty_Template_Source $source) {
        ...
        call_user_func_array(
                $source->smarty->registered_resources[$source->type][0][1], array($source->name, &$time_stamp, $source->smarty)
        );
    ...
    public function getContent(Smarty_Template_Source $source) {
        ...
        $t = call_user_func_array(
                $source->smarty->registered_resources[$source->type][0][0], array($source->name, &$content, $source->smarty)
        );
        if (is_bool($t) && !$t) {
